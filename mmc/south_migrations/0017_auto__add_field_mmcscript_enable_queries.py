...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MMCScript.enable_queries'
        db.add_column('mmc_mmcscript', 'enable_queries',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MMCScript.enable_queries'
        db.delete_column('mmc_mmcscript', 'enable_queries')
