...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mmc_mmcscript', 'last_call',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2016, 9, 23, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'MMCScript.max_elapsed'
        db.add_column('mmc_mmcscript', 'max_elapsed',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MMCScript.last_call'
        db.delete_column('mmc_mmcscript', 'last_call')

        # Deleting field 'MMCScript.max_elapsed'
        db.delete_column('mmc_mmcscript', 'max_elapsed')
