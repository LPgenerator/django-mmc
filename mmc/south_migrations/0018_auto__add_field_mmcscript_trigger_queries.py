...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MMCScript.trigger_queries'
        db.add_column('mmc_mmcscript', 'trigger_queries',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MMCScript.trigger_queries'
        db.delete_column('mmc_mmcscript', 'trigger_queries')
