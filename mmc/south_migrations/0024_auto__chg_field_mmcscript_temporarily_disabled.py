...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MMCScript.temporarily_disabled'
        db.alter_column('mmc_mmcscript', 'temporarily_disabled', self.gf('django.db.models.fields.SmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'MMCScript.temporarily_disabled'
        db.alter_column('mmc_mmcscript', 'temporarily_disabled', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        'mmc.mmcemail': {
            ...
            'ignore': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['mmc.MMCScript']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'mmc.mmcscript': {
            ...
            'last_call': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'max_elapsed': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            ...
            'temporarily_disabled': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'track_at_exit': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
