...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MMCScript.save_on_error'
        db.add_column(u'mmc_mmcscript', 'save_on_error',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MMCScript.save_on_error'
        db.delete_column(u'mmc_mmcscript', 'save_on_error')
    ...
    models = {
        ...
        u'mmc.mmclog': {
            ...
            'hostname': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mmc.MMCHost']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'script': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mmc.MMCScript']"}),
