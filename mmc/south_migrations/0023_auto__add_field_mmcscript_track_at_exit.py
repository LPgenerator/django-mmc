...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MMCScript.track_at_exit'
        db.add_column('mmc_mmcscript', 'track_at_exit',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MMCScript.track_at_exit'
        db.delete_column('mmc_mmcscript', 'track_at_exit')
